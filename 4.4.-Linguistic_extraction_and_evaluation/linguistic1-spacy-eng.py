...
extractor.load_sl_tagged_corpus("corpus-tagged-spacy-eng.txt")
extractor.load_linguistic_patterns("POS-patterns-spacy-eng.txt")
extractor.tagged_ngram_calculation(nmin=1,nmax=3,minfreq=2)
extractor.linguistic_term_extraction(minfreq=2)
extractor.save_term_candidates("candidates-linguistic-spacy-eng.txt",minfreq=2)
