...
extractor.load_evaluation_terms("corp_en_terms_nes-bigrams.ann")

measures=[("raw_freq","desc"),("student_t","desc"),("chi_sq","asc"),("mi_like","desc"),("likelihood_ratio","asc"),("poisson_stirling","desc"),("pmi","asc"),("jaccard","desc"),("phi_sq","desc"),("z_score","desc"),("loglikelihood","desc"),("MI","desc"),("MI2","desc"),("MI3","desc"),("odds","desc")]
...
cadena="\\begin{small}"
sortida.write(cadena+"\n")
cadena="\\begin{tabular}{|l|r|r|r|r|r|r|r|r|r|r|r|r|r|r|r|}"
sortida.write(cadena+"\n")
cadena="\\hline"
sortida.write(cadena+"\n")
cadena="\\rotatebox[origin=c]{90}{\\textbf{ Position }} & \rotatebox[origin=c]{90}{\\textbf{ raw\_freq }} & \rotatebox[origin=c]{90}{\\textbf{ student\_t }} & \rotatebox[origin=c]{90}{\\textbf{ chi\_sq }} & \rotatebox[origin=c]{90}{\\textbf{ mi\_like }} & \rotatebox[origin=c]{90}{\\textbf{ likelihood\_ratio }} &  \rotatebox[origin=c]{90}{\\textbf{ poisson\_stirling }} & \rotatebox[origin=c]{90}{\\textbf{ pmi }} & \rotatebox[origin=c]{90}{\\textbf{ jaccard }} & \rotatebox[origin=c]{90}{\\textbf{ phi\_sq }} & \rotatebox[origin=c]{90}{\\textbf{ z\_score }} & \rotatebox[origin=c]{90}{\\textbf{ loglikelihood }} & \rotatebox[origin=c]{90}{\\textbf{ MI }} & \rotatebox[origin=c]{90}{\\textbf{ MI2 }} & \rotatebox[origin=c]{90}{\\textbf{ MI3 }} & \rotatebox[origin=c]{90}{\\textbf{ odds }}\\\\"
sortida.write(cadena+"\n")
cadena="\\hline"
sortida.write(cadena+"\n")
for position in [10,50,100,200,500,1000,2000]:
